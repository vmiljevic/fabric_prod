...
dataset = "IT Finance CE - Semantic Model" # Enter the name or ID of the semantic model
workspace = "PBI-IT-Finance PBI" # Enter the workspace name or ID in which the semantic model exists
